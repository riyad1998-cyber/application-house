...
const ApplicationsDetail = () => {
    ...
    <p className='text-gray-500 mb-4'>The app you looking for does not exist or has benn removed.</p>
    <Link
      to="/applications"
    ...
    const {
        companyName,title,downloads,ratingAvg,image,size,Developer,reviews,ratings,description} = application;
            ...
            <div className='flex flex-col lg:flex-row w-full max-w-[1700px] mx-auto gap-10 mt-[40px] px-4 sm:px-6 '>
                ...
                <div className='flex-1'>
                    ...
                    <div className='flex justify-center lg:justify-start'>
                        <button onClick={hadnleInstalled} className='bg-[#00D390] text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-800 transition w-full sm:w-[239px] h-[50px]'>
                            Install Now ({size})
                        </button>
                    </div>
                </div>
...
<div className='w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-8 mt-10 mb-10'>
  <h1 className='text-2xl sm:text-2xl md:text-2xl font-bold'>
    Description
  </h1>
  <p className='mt-4 sm:mt-6 text-gray-500 text-sm sm:text-base md:text-lg'>
    {description}
  </p>
</div>
