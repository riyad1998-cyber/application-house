...
const Installation = () => {
    ...
    const handleUninstall = (id, companyName)=> {
        ...
        toast.success(`${companyName} is uninstalled!`, {
            position: "top-right",
            autoClose: 3000,
        ...
        <div>
            ...
            <div className='space-y-4'>
                {installed.map((instal, index)=>(
                    <div key={index} className='w-full max-w-[1700px] mx-auto px-3 sm:px-4 mb-4'>
                        <div className='bg-white shadow-sm flex flex-col sm:flex-row justify-between items-center sm:items-center p-4 rounded-lg gap-4'>
                            ...
                            {/* Right */}
                            <button
                                onClick={()=> handleUninstall(instal.id, instal.companyName)}
