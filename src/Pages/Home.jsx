...
<div className='mx-auto max-w-[1700px] px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 mt-10 gap-4'>
{
  ...
  <Link
    to="/applications"
    className="btn flex items-center justify-center gap-2 bg-gradient-to-r from-[#632EE3] to-[#9F62F2] text-white rounded-lg w-[145px] h-12 sm:text-xl text-base hover:scale-105 transition-transform"
  >
    Show All
  </Link>
</div>
